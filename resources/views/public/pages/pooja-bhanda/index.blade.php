                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <p class="ms-1 text-sm font-medium text-gray-700 md:ms-2">Create Product</p>
                        </div>
                    </li>
                </ol>
            </nav>
        ...
        <div class="p-6">
            <div class="flex flex-col border-2 h-full rounded-lg p-6">
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    <div>
                        <label for="item_name" class="block mb-2 text-sm font-medium text-black">Product Name</label>
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    <div>
                        <label for="cost" class="block mb-2 text-sm font-medium text-black">Cost</label>
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <div>
                        <label for="min_quantity" class="block mb-2 text-sm font-medium text-black">Minimum
                            Quantity</label>
                        <input type="number" id="min_quantity" min="0"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                ...
                <div class="flex justify-center items-center w-full gap-4 p-4">
                    <button class="py-3 px-6 bg-basic text-white rounded-lg">Save</button>
                    <button class="py-3 px-6 bg-black text-white rounded-lg">Reset</button>
                </div>
            </div>
        </div>
...
<script>
    ...
    document.title = `${appName} | Poojabhanda Management`;
</script>
@endpush
